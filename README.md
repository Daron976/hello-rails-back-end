...
This is a rails back end application that deals with the database for a react front-end application
...
- **Setup backend for react frontend**
...
- [Front-End application PR Link](https://github.com/Daron976/hello-react-front-end/pull/1)
